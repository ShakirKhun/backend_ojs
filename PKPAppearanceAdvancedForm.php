...
class PKPAppearanceAdvancedForm extends FormComponent
{
    ...
    public function __construct($action, $locales, $context, $baseUrl, $temporaryFileApiUrl, $imageUploadUrl)
    {
        ...
        $this->addField(new FieldUpload('styleSheet', [
			...
			->addField(new FieldRichTextarea('aboutText', [
                'label' => __('manager.setup.aboutText'),
                'description' => __('manager.setup.aboutText.description'),
                'isMultilingual' => true,
                'value' => $context->getData('aboutText'),
                'toolbar' => 'bold italic superscript subscript | link | blockquote bullist numlist | image | code',
                'plugins' => 'paste,link,lists,image,code',
                'uploadUrl' => $imageUploadUrl,
            ]))
			->addField(new FieldRichTextarea('heroTitle', [
                'label' => __('manager.setup.heroTitle'),
                'description' => __('manager.setup.heroTitle.description'),
                'isMultilingual' => true,
                'value' => $context->getData('heroTitle'),
                'toolbar' => 'bold italic superscript subscript | link | blockquote bullist numlist | image | code',
                'plugins' => 'paste,link,lists,image,code',
                'uploadUrl' => $imageUploadUrl,
            ]))
			->addField(new FieldRichTextarea('heroText', [
                'label' => __('manager.setup.heroText'),
                'description' => __('manager.setup.heroText.description'),
                'isMultilingual' => true,
                'value' => $context->getData('heroText'),
                'toolbar' => 'bold italic superscript subscript | link | blockquote bullist numlist | image | code',
                'plugins' => 'paste,link,lists,image,code',
                'uploadUrl' => $imageUploadUrl,
            ]))
			->addField(new FieldUploadImage('heroBackground', [
                'label' => __('manager.setup.heroBackground'),
                'value' => $context->getData('heroBackground'),
                'isMultilingual' => true,
                'baseUrl' => $baseUrl,
                'options' => [
                    'url' => $temporaryFileApiUrl,
			...
			->addField(new FieldUploadImage('heroForeground', [
                'label' => __('manager.setup.heroForeground'),
                'value' => $context->getData('heroForeground'),
                'isMultilingual' => true,
                'baseUrl' => $baseUrl,
                'options' => [
                    'url' => $temporaryFileApiUrl,
			...
			->addField(new FieldRichTextarea('recommendationText', [
                'label' => __('manager.setup.recommendationText'),
                'description' => __('manager.setup.recommendationText.description'),
                'isMultilingual' => true,
                'value' => $context->getData('recommendationText'),
                'toolbar' => 'bold italic superscript subscript | link | blockquote bullist numlist | image | code',
                'plugins' => 'paste,link,lists,image,code',
                'uploadUrl' => $imageUploadUrl,
            ]));
